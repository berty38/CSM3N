...
for run = 1:totalRuns
	...
	[X,Y,A,pSame_tr(run)] = genMarkovChain(chainLength, k, pSameMin, pSameMax, pObs);
	
	for i = 1:numTest
		[Xte{i},Yte{i},Ate{i},pSame_te(run,i)] = genMarkovChain(chainLength, k, pSameMin, pSameMax, pObs);
	end
